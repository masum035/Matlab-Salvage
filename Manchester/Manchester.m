...
%% ----------For manchester signal -----------%%
[t,s] = manChester(bits,frequency);
subplot(2,1,2);
figure(1);
...
title(["Manchester Output Signal" num2str(bits)]);
xlabel("Time Period");
ylabel("Bits");
...
% manchester function
function [time_series,output_signal] = manChester(bits, bitrate)
